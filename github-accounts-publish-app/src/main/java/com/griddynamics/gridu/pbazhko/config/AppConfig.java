...
public class AppConfig {
    ...
    @Bean
    public Schema gitHubAccountsSchema(Environment env) {
        return GitHubAccountsSchemaProvider.getSchema(
            env.getProperty("KAFKA_GITHUB_ACCOUNTS_TOPIC"),
            env.getProperty("KAFKA_SCHEMA_REGISTRY")
        );
    }
